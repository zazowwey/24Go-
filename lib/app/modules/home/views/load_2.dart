...
class Load2 extends StatelessWidget {
  const Load2({super.key});
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        child: Column(  
          ...
          Container(
            margin: EdgeInsets.only(top: 180,bottom:20), // Jarak atas 20px
           child: Image.asset(
              "img/PJBL2-IMAGE/load3.jpg",
              width: 350,
              height: 350,
              fit: BoxFit.cover,
            ),
          ...
          child: Image.asset(
            "img/PJBL2-IMAGE/PJBL2-ICON/load3.png",
          ),
          ),
